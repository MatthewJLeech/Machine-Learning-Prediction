...
# %% SalePrice distribution with respect to CentralAir / OverallQual / BldgType / etc
...
# %%running the same above, substituting Neighborhood for Years and reducing number shown
...
print("I thiink I did better than a dummy regressor!")
